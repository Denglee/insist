                    ...
                    <el-col :md="8" :lg="8">
                        <div class="index-item index-item2">
                            ...
                            <div class="flex-between">
                                ...
                                <ul class="vipNum">
                                    <li>私教会员： <span class="colorYellow">{{totalVipOverdue.series[0].data[0].value}}</span></li>
                ...
                <div class="index-item">
                    ...
                    <el-row >
                        ...
                        <el-col :md="8" class="vip-item-num">
                            ...
                            <div class="flex-between">
                                <eCharts :eChartObj="VipLesson" :style="styleVip"></eCharts>
                                <ul class="vipNum">
                                    <li>潜在会员： <span class="vipTipG">{{VipLesson.series[0].data[0].value}}</span></li>
                                    <li>正式会员： <span class="vipTipB">{{VipLesson.series[0].data[1].value}}</span></li>
                                </ul>
                            </div>
                        </el-col>
                        <!--会籍 -->
                        <el-col :md="8"  class="vip-item-num">
                            ...
                            <div class="flex-between">
                                <eCharts :eChartObj="VipAdd" :style="styleVip"></eCharts>
                                <ul class="vipNum">
                                    <li>期限卡： <span class="colorYellow">{{VipAdd.series[0].data[0].value}}</span></li>
                                    <li>次卡： <span class="colorRed">{{VipAdd.series[0].data[1].value}}</span></li>
                                </ul>
                            </div>
                        </el-col>
                        <!--已跟进-->
                        <el-col :md="8"  class="vip-item-num">
                            ...
                            <div class="flex-between">
                                <eCharts :eChartObj="VipFollow" :style="styleVip"></eCharts>
                                <ul class="vipNum">
                                    <li>已跟进： <span class="colorRed">{{VipFollow.series[0].data[0].value}}</span></li>
                                    <li>未跟进： <span class="colorBlue">{{VipFollow.series[0].data[1].value}}</span></li>
                                </ul>
                            </div>
                        </el-col>
                    </el-row>
