        ...
        <div class="detail-box">
            ...
            <div class="ptTable-assist">
                ...
                <el-table class="pub-table" :data="saleRoomInfo" border>
                    ...
                    <el-table-column prop="total_number" label="总次数"></el-table-column>
...
<script>
    import {PTexpireCoach} from '@/assets/js/api' /*引用  接口*/
    export default {
        name: "ptExpireCoach",  //私教到期提醒
        props: {
            ptSalesPage: {
                type: Number,
            },
        ...
        methods: {
            /*销售额查询*/
            getPTSaleroom() {
                PTexpireCoach(this.searchVal).then(res => {
