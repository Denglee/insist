        ...
        <div class="detail-box">
            ...
            <div class="ptTable-assist">
                ...
                <el-table class="pub-table" :data="saleRoomInfo" border>
                    ...
                    <el-table-column prop="card_price" label="总金额"></el-table-column>
                    <el-table-column prop="diff" label="剩余金额">
                        <template slot-scope="scope">
                            <div class="ptContract-diff">{{scope.row.diff}}</div>
                        </template>
                    </el-table-column>
...
<script>
    import {PTexpireSki} from '@/assets/js/api' /*引用  接口*/
    export default {
        name: "MBexpireSki",  //滑雪到期提醒
        props: {
            ptSalesPage: {
                type: Number,
            },
        ...
        methods: {
            /*销售额查询*/
            getPTSaleroom() {
                PTexpireSki(this.searchVal).then(res => {
