...
<script>
    import {PTexpireNum} from '@/assets/js/api' /*引用  接口*/
    export default {
        name: "MBexpireOnce",  //次卡到期提醒
        props: {
            ptSalesPage: {
                type: Number,
            },
        ...
        methods: {
            /*销售额查询*/
            getPTSaleroom() {
                PTexpireNum(this.searchVal).then(res => {
