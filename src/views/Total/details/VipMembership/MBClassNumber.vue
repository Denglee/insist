        ...
        <div class="detail-box">
            <header class="index-item-title flex-between">
                ...
                <div class="vipNav-rBox">
                    ...
                    <el-button v-show="ptSalesPage == 5" class="btn-ptMore" @click="btnTotalMore('tabPaneState','vNumD')">
...
<script>
    ...
    import {MBclassNumber,staffGroup} from '@/assets/js/api' /*引用  接口*/
    export default {
        name: "statisDetails",  //私教销售额查询
        props:{
            ptSalesPage:{
                type:Number,
            },
        ...
        methods: {
            /*数量详情*/
            getPTSaleroom(){
                MBclassNumber(this.searchVal).then(res => {
