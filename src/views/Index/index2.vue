            ...
            <el-col :md="12" :lg="8">
                <div class="index-item">
                    ...
                    <div class="flex-between">
                        ...
                        <ul class="vipNum">
<!--                            <li>潜在会员： <span class="vipTipG">{{chartVipData[0].potential_members}}</span></li>-->
<!--                            <li>正式会员： <span class="vipTipG">{{chartVipData[1].official_members}}</span></li>-->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getTotal(){
                ...
                IndexTotal_membership().then(res => {
                    ...
                    /*现有会员  数据*/
                    this.$nextTick(()=>{
                        that.chartVipData = res;
                        console.log(that.chartVipData[0].name);
                        console.log(that.chartVipData[1].name);
                    });
                }).catch(res =>{
                   console.log(res);
                });
        ...
        created() {
            ...
            /*调用 获取收数据接口 方法*/
            // this.getTotal();
            this.chartVipData.series[0].data = [
                // {value: 335, name: '直接访问'},
                // {value: 310, name: '邮件营销'},
                // {value: 234, name: '联盟广告'},
                {
                    name:'1',
                    potential_members:'20',
                },{
                    name:'2',
                    official_members:'10',
                }
